...
$(function(){
	...
	var cityName2 = Utils.parseUrlParam(window.location.href, 'name2');
	var provinceId = Utils.parseUrlParam(window.location.href, 'provinceId');
	...
	$('#regionCancelButton').click(function(){
		...
		window.location.href = '#' + pageName + '?parentId=' + parentId 
								+ '&name=' + cityName
								+ '&name2=' + cityName2
...
//				window.location.href = 'index.html#region_district?parentId=' + $(e.target).attr('pk') + '&name=' + $(e.target).attr('cityName');
//			},
			goEdit: function(e){
...
function goAdd(){
	...
	var cityName2 = Utils.getUrlParam('name2');
	var provinceId = Utils.getUrlParam('provinceId');
	
	window.location.href = '#' + pageName + '?action=add&parentId=' + parentId 
							+ '&name=' + cityName
							+ '&name2=' + cityName2
							+ '&provinceId=' + provinceId;
}
...
function routeCallBack(){
	...
	navMenus.push({text:cityName,link:'#region_city?parentId=' + provinceId + '&name=' + cityName});
	navMenus.push({text:cityName2,link:'#' + page + '?parentId=' + parentId + '&name=' + cityName + '&name2=' + cityName2 + '&provinceId=' + provinceId});
