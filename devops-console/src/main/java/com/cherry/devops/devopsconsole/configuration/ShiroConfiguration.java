...
import com.cherry.devops.devopsconsole.realm.DevopsShiroRealm;
 ...
 * @Description TODO
 * @Author lixiaolong
 * @Date Created in 2018/11/23 15:26
 * @Version 1.0
 * @Modified by lixiaolong-2018/11/23 15:26
 */
@Configuration
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        // 设置realm.
        securityManager.setRealm(devopsShiroRealm());
     ...
     */
    @Bean
    public DevopsShiroRealm devopsShiroRealm() {
        DevopsShiroRealm devopsShiroRealm = new DevopsShiroRealm();
        return devopsShiroRealm;
    }
