package com.cherry.devops.devopsconsole.realm;
...
/**
 * @ClassName DevopsShiroRealm
 * @Description TODO
 * @Author lixiaolong
 * @Date Created in 2018/11/23 15:30
 * @Version 1.0
 * @Modified by lixiaolong-2018/11/23 15:30
 */
public class DevopsShiroRealm extends AuthorizingRealm {
...
//            redissonClient.getMapCache(Constants.REDIS_RESOURCE).put(user.getId(), resourceList);
//        }
